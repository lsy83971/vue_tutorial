...
// w(n) h(n) means block width and height
//      ---------------------------------
//      |3            -------           | 
//      | ---------   |2    |           | 
//      | |1      |   |     | --------- | 
...
// id: "c_0"
// name: "c_0"
// onshow: "v" #v mean show code on the block; id means show id; rawname means show name;
// rawname: "c_0"
// show: 1 #1 mean is unfolded 0 means is folded
// sur: 0 # 0 if no surfix; otherwise valued surfix id
// v: "as $f" # v;id;rawname;name 
// w1: 180
// w2: 0
// w2_add: 0 ## add wspace between 1 and 2
// w3: 180
// w4: 0
// w4_add: 0 ## add wspace between 1 and 4
// x0: 200
// x1: 110
// x2: 290
// x3: 290
...
// FlaskSendCode: send code of the code block
//   url:flask/code
//   format: {'code':code,'context':{'node':'c_0'}}
//   use which node as shortcut context

// FlaskSendTree: run tre
//   url:flask/tree
//   format: {'info':pxy.info,'struct':pxy.struct,'opts':pxy.opts}

// FlaskLoadjson: load_json
//   url: flask/loaddata
//   format: json text
